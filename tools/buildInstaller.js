...
if (isDarwin) {
  ...
  const wvBundleDir = buildDir + '/Brave.app/Contents/Frameworks/Widevine Resources.bundle/Contents/Resources'
  const wvBundleSig = wvBundleDir + '/Brave Framework.sig'
